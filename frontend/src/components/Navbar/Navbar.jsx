...
const Navbar = () => {
  ...
  return (
    <>
      <nav className=" relative z-50 bg-zinc-800 text-white px-8 py-4 flex items-center  justify-between gap-4 ">
        ...
        <div className="nav-links-bookheaven block  md:flex items-center gap-10 ">
